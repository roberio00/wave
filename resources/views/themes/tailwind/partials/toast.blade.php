                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 w-0 pl-3.5 ml-1 border-l border-gray-100">
                        <p class="text-sm font-medium leading-5 text-gray-900">
                            <template x-if="$store.toast.type == 'info'"><span>Notícia</span></template>
                            <template x-if="$store.toast.type == 'warning'"><span>Aviso</span></template>
                            <template x-if="$store.toast.type == 'success'"><span>Sucesso</span></template>
                            <template x-if="$store.toast.type == 'danger'"><span>Algo deu errado</span></template>
                        </p>
